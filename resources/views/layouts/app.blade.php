        ...
        <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
            <div class="position-sticky pt-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('register') }}" class="nav-link text-start" style="color: rgba(255, 255, 255, 0.8);">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('users.index') }}" class="nav-link text-start" style="color: rgba(255, 255, 255, 0.8);">
                            <i class="fas fa-users me-2"></i>
                            Listar Usuários
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="nav-link text-start" style="background: none; border: none; color: rgba(255, 255, 255, 0.8);">
